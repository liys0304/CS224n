...
\begin{parts}
    ...
    $[$ROOT, attended, in, the, NLP] & [class] &  &  \texttt{SHIFT}  \\
    $[$ROOT, attended, in, the, NLP, class] & [] &  &  \texttt{SHIFT}  \\
    $[$ROOT, attended, in, the, class] & [] & class$\to$NLP &  \texttt{LEFT-SHIFT}  \\
    $[$ROOT, attended, in, class] & [] & class$\to$the &  \texttt{LEFT-SHIFT}  \\
    $[$ROOT, attended, class] & [] & class$\to$in &  \texttt{LEFT-SHIFT}  \\
    $[$ROOT, attended] & [] & attended$\to$class &  \texttt{RIGHT-SHIFT}  \\
    $[$ROOT] & [] &  &    \\
    \end{tabular}\newline
	...
	\begin{shaded}
		answer: cartlen number. Because it is a combination of pop sequences.
	\end{shaded}
